...
const isRedSide = (attacker) => attacker.includes('후티');
...
function _renderSummary(total) {
    document.getElementById('tl-summary').innerHTML =
        ...
        `<span class="legend"><img src="./images/red-explosion.png" alt="">후티 반군</span>` +
        `<span class="legend"><img src="./images/blue-explosion.png" alt="">사우디 주도 연합군</span>` +
