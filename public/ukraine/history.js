...
const isRedSide = (attacker) => attacker.includes('러시아');
...
function _renderSummary(total) {
    document.getElementById('tl-summary').innerHTML =
        ...
        `<span class="legend"><img src="./images/red-explosion.png" alt="">러시아군</span>` +
        `<span class="legend"><img src="./images/blue-explosion.png" alt="">우크라이나군</span>` +
